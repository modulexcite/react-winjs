...
(function () {
    ...
    (function (factory) {
        if (typeof define === 'function' && define.amd) {
            ...
            globalObject.msWriteProfilerMark && msWriteProfilerMark('$(TARGET_DESTINATION) $(build.version).$(build.branch).$(build.date) intrinsics.js,StartTM');
            ...
            globalObject.msWriteProfilerMark && msWriteProfilerMark('$(TARGET_DESTINATION) $(build.version).$(build.branch).$(build.date) intrinsics.js,StopTM');
        }
    }(function (WinJS) {
